...
export function render(container) {
  ...
  container.innerHTML = `
    <div class="screen-scroll">
      ...
      <!-- Score Crown -->
      <div class="card" style="padding: 32px 24px; display: flex; flex-direction: column; align-items: center; gap: 16px;">
        <div style="position: relative; width: 100%; max-width: 280px; height: 180px; display: flex; justify-content: center;">
          ...
          <div style="position: absolute; inset: 0; bottom: 20px; display: flex; flex-direction: column; align-items: center; justify-content: flex-end;">
            ...
            <span style="font-size: 16px; font-weight: 600; color: ${PALETTE.sleep}; margin-top: 4px;">Sleep</span>
          </div>
        </div>
        <p style="font-size: 15px; color: var(--text-secondary); line-height: 1.5; text-align: center; max-width: 300px;">${getSleepInsight()}</p>
      </div>
